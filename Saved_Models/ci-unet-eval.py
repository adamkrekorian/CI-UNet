...
net.load_state_dict(torch.load("./ci-unet.pt"))
net.eval()
...
plt.colorbar()
plt.title("Reverberant Spectrogram (256 Bins)")
...
plt.colorbar()
plt.title("Predicted Spectrogram (256 Bins)")
plt.xlabel("Time Domain")
plt.ylabel("Frequency Domain")
...
plt.colorbar()
plt.title("Direct Path Spectrogram (256 Bins)")
plt.xlabel("Time Domain")
plt.ylabel("Frequency Domain")

plt.savefig("res-eval-256-1.png")
